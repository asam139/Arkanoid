...
---------------Points--------------
pointsTag = display.newText("Points:", 0, 0, typeLetter, paddingUp * 0.25 )
pointsTag.x = _w - pointsTag.width * 0.5
pointsTag.y = paddingUp * 0.5 + pointsTag.height * 0.5
pointsTag:setTextColor(1, 1, 0, 1)


scoreBoardPoints = display.newText(totalPoints, 0, 0, typeLetter, paddingUp * 0.25)
...
paleta = display.newRoundedRect(0, 0, widthPaleta, heightPaleta,5)
paleta.x = _w
paleta.y = _H * 0.9
...
--Ball
ball = display.newCircle(0, 0, ratioBall)
ball.x = paleta.x
